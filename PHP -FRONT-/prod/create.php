            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="ajouter.php">
                    <div class="form-group">
                      <label for="exampleInputName1">Nom</label>
                      <input type="text" name="nom" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">prix</label>
                      <input type="text" name="prix" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">image</label>
                      <input type="file" name="img" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">date</label>
                      <input type="date" name="date" class="form-control" id="exampleInputEmail3" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">id_categorie</label>
                      <input type="text" name="id_cat" class="form-control" id="exampleInputEmail3" placeholder="">
                    </div>
