                        ...
                        <?php
                          ...
                          foreach($jsonDecode as $mydata){
                            ?>
                              ...
                              <td>
                            <?php echo $mydata['id_cat'];?> <!-- les params dans jsom-->
                          </td>
                          <td>
                          <?php echo $mydata['libelle'];?>
                          </td>
                          
                          <td>
                            <a href="http://localhost:8081/produits/phpcat/modifierCat/id/<?php echo $mydata['id_cat']; ?>">modifier</a>||<a href="http://localhost:8081/produits/phpcat/supprimerCat/id/<?php echo $mydata['id_cat']; ?>">supprimer</a>
                          </td>
                        </tr>
