            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="http://localhost:8081/produits/user/updateUser" method="post">
                    <div class="form-group">
                      <label for="exampleInputName1">Id</label>
                      <input type="text" name="id_user" value="<?php echo $params['id'] ?>" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputName1">image</label>
                      <input type="file" name="image" value="<?php echo $params['image'] ?>" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputName1">Email</label>
                      <input type="mail" name="mail"  value="<?php echo $params['mail'] ?>" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputName1">Mot de passe</label>
                      <input type="password" name="passwd" value="<?php echo $params['password'] ?>" class="form-control" id="exampleInputName1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Role</label>
                      <select name="admn" id="exampleInputName1">
                          <option value="1" <?php if($params['role']==1){
                                echo "selected";
                          } ?>>admin</option>
                          <option value="0" <?php if($params['role']==0){
                                echo "selected";
                          } ?>>client</option>
                      </select>
                    </div>
