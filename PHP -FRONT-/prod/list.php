                        ...
                        <?php
                          ...
                          foreach($jsonDecode as $mydata){
                            ?>
                              ...
                              <td>
                            <?php echo $mydata['idProduit'];?>
                          </td>
                          <td>
                            <?php echo $mydata['nomProduit'];?>
                          </td>
                          <td>
                          <?php echo $mydata['prixProduit'];?>
                          </td>
                          <td>
                          <img src="image/<?php echo $mydata['image'];?>" alt="">
                          </td>
                          <td>
                          <?php echo $mydata['dateCreation'];?>
                          </td>
                          <td>
                          <?php echo $mydata['id_cat'];?>
                          </td>
                          <td>
                            <a href="http://localhost:8081/produits/php/modifierProd/id/<?php echo $mydata['idProduit']; ?>">modifier</a>||<a href="http://localhost:8081/produits/php/supprimerProd/id/<?php echo $mydata['idProduit']; ?>">supprimer</a>
                          </td>
                        </tr>
