...
// $date = date('m/d/Y', $params['date']);
$s = strtotime($params['date'] );
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="http://localhost:8081/produits/php/updateProd" method="post">
                    <div class="form-group">
                      <label for="exampleInputName1">Id</label>
                      <input type="text" name="idProduit" value="<?php echo $params['id'] ?>" class="form-control" id="exampleInputName1" placeholder="Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Nom</label>
                      <input type="text" name="nomProduit" value="<?php echo $params['nom'] ?>" class="form-control" id="exampleInputName1" placeholder="Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">prix</label>
                      <input type="text" name="prixProduit" value="<?php echo $params['prix'] ?>" class="form-control" id="exampleInputName1" placeholder="Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">image</label>
                      <input type="file" name="image" value="<?php echo $params['image'] ?>" class="form-control" id="exampleInputName1" placeholder="image">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">date de creation </label>
                      <input type="date" name="date"  value="<?php echo $date?>" class="form-control" id="exampleInputEmail3" placeholder="Email">
                    </div>
