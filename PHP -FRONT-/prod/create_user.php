            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="ajouter_user.php">
                    <div class="form-group">
                      <label for="exampleInputName1">image</label>
                      <input type="file" name="img" class="form-control" id="exampleInputName1" placeholder="image">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Email</label>
                      <input type="mail" name="mail" class="form-control" id="exampleInputName1" placeholder="Email">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Mot de passe</label>
                      <input type="password" name="password" class="form-control" id="exampleInputName1" placeholder="mot de passe">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Role</label>
                      <select name="role" id="exampleInputName1">
